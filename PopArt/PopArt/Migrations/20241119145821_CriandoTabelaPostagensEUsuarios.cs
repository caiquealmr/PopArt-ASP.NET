...
{
    /// <inheritdoc />
    public partial class CriandoTabelaPostagensEUsuarios : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FotoDePerfil = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LinkBehance = table.Column<string>(type: "nvarchar(max)", nullable: true),
